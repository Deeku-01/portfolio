...
const HeroSection = () => {
  return (
    <div className="mb-20 mt-10 md:mt-0 animate-fade-in" style={{ animationDelay: "0.1s" }}>
      ...
      <p className="text-xl font-semibold text-primary mb-2 animate-fade-in" style={{ animationDelay: "0s" }}>
        Deekshith V.
      </p>
      
      <h1 className="text-4xl md:text-5xl font-extrabold text-foreground mb-6 tracking-tight">
        Building digital 
        experiences with <span className="text-primary">purpose.</span>
      </h1>
      
      <p className="text-muted-foreground text-lg leading-relaxed max-w-4xl mb-8">
        <span className="text-primary text-2xl font-semibold">I don't just write code; I design systems.</span> Blending full-stack development with a strong foundation in cybersecurity, I specialize in delivering accessible and performant web applications. 
        My next challenge involves diving deep into DevOps and the architecture of complex, distributed systems.
